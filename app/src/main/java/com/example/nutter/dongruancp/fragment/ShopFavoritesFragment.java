 ...
 */
public class ShopFavoritesFragment extends BaseFragment {
    public RecyclerView recyclerView;
    public CollectionAdapter adapter;


    public ShopFavoritesFragment() {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        recyclerView = (RecyclerView) view.findViewById(R.id.recycler_View_shopfavor);
        ...
        Call<List<userCollection>> call=service.getAllUserCollection(Integer.parseInt(getUserId()),0);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_shop_favorites, container, false);
    }
